...
4. **سجل القرارات (إلحاقي):** كل الأحداث السابقة بترتيب زمني: من، متى، ماذا، البصمة المختوم عليها — **لا زر حذف ولا تعديل**؛ التراجع = قرار جديد يعقب القديم ويعلوه، والقديم يبقى مقروءاً [DECISION GREENFIELD §16.2-8؛ ASSUME OD-11: إنهاء السريان (retire) للمدير حصراً — ويبقى السجل كاملاً مقروءاً، وحتى الإنهاء إلحاقي التسجيل].
