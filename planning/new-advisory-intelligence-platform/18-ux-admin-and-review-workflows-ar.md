...
**قواعد الصياغة:** قبل الاعتماد: «مؤشر مشتبه به» حصراً؛ بعده: «حالة معتمدة ضمن {VIOL-xxx}»؛ لا تظهر كلمة «إدانة» أو «مخالف» كوصف شخص في أي نص واجهة [DECISION §2.4]؛ والتنويه الثابت (§5.1 أعلاه) لا يُحذف من أي عرض لقائمة الاشتباه أو حالاتها.
